package co.com.google.certification.authentication.interactions.authentication;
...
public class Authenticate implements Interaction {
    ...
    public static Authenticate authenticateWhitTheNext(Credentials credentials){
